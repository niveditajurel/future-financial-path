...
const HeroSection = () => (
  <section className="relative py-16 md:py-24 lg:py-32 px-4 bg-gradient-to-b from-background via-background/95 to-transparent overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
      ...
      <div className="relative z-10 flex flex-col items-start text-left space-y-6 md:space-y-8 lg:space-y-10 animate-luxurious-fade-in">
        <div className="space-y-6 md:space-y-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-tight font-bold tracking-tight">
            ...
            <span 
              className="inline-block bg-primary text-white px-4 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl font-bold text-lg md:text-xl lg:text-2xl xl:text-4xl shadow-2xl animate-premium-glow btn-classy-hover"
          ...
          <p 
            className="text-lg md:text-xl lg:text-2xl text-muted-foreground font-medium max-w-2xl leading-relaxed animate-text-reveal"
        ...
        <div 
          className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 animate-elegant-slide-up"
          style={{ animationDelay: '1.2s' }}
        >
          <div className="flex -space-x-3">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary to-accent border-2 md:border-3 border-white shadow-xl animate-sophisticated-float" style={{ animationDelay: '0s' }} />
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-accent to-primary border-2 md:border-3 border-white shadow-xl animate-sophisticated-float" style={{ animationDelay: '1s' }} />
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-primary to-success border-2 md:border-3 border-white shadow-xl animate-sophisticated-float" style={{ animationDelay: '2s' }} />
          </div>
          <div>
            <p className="text-foreground font-bold text-base md:text-lg">12,000+ people</p>
            <p className="text-muted-foreground text-sm md:text-base">building wealth with AI</p>
          </div>
        </div>
        ...
        <div 
          className="flex flex-col sm:flex-row items-start sm:items-center gap-6 md:gap-10 text-muted-foreground animate-text-reveal"
        ...
        >
          ...
          <div className="flex items-center gap-2 md:gap-3 hover-card-lift">
            <Star className="w-4 h-4 md:w-5 md:h-5 text-primary animate-elegant-pulse" style={{ animationDelay: '0.5s' }} />
      ...
      <div 
        className="relative z-10 animate-luxurious-fade-in mt-8 lg:mt-0"
      ...
      >
        <div className="bg-gradient-to-br from-white/8 to-white/12 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl border border-white/20 hover-card-lift">
          ...
          <div className="text-center mt-6 md:mt-8 space-y-2 md:space-y-3 animate-text-reveal" style={{ animationDelay: '2s' }}>
          ...
          >
            <div className="bg-white/90 dark:bg-muted/80 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl hover:shadow-3xl border border-white/20 hover:border-primary/30 space-y-4 md:space-y-6 h-full hover-card-lift">
              <div className="flex justify-center">
                <div className="p-3 md:p-4 bg-primary/10 rounded-xl md:rounded-2xl group-hover:bg-primary/20 transition-all duration-500 animate-sophisticated-float" style={{ animationDelay: `${i * 0.5}s` }}>
          ...
          >
            <div className="bg-white/95 dark:bg-background/90 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl hover:shadow-3xl border border-white/20 hover:border-primary/20 space-y-6 md:space-y-8 h-full hover-card-lift">
              ...
              <div className="flex items-center gap-3 md:gap-4">
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-gradient-to-br from-primary to-accent animate-sophisticated-float" style={{ animationDelay: `${idx * 2}s` }} />
...
const CTASection = () => (
  <section className="py-20 md:py-24 lg:py-32 px-4 text-center bg-gradient-to-br from-primary via-primary/95 to-accent relative overflow-hidden">
    ...
    <div className="relative z-10 max-w-4xl mx-auto space-y-8 md:space-y-10 lg:space-y-12 animate-luxurious-fade-in">
      <div className="space-y-6 md:space-y-8">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed animate-text-reveal" style={{ animationDelay: '0.3s' }}>
      ...
      <div className="space-y-6 md:space-y-8 animate-elegant-slide-up" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-8 text-white/80 text-base md:text-lg">
          ...
          <div className="flex items-center gap-2 md:gap-3 hover-card-lift">
            <CheckCircle className="w-5 h-5 md:w-6 md:h-6 animate-elegant-pulse" style={{ animationDelay: '0.5s' }} />
